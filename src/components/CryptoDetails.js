...
const CryptoDetails = () => {
  ...
  if(isFetching) return <LoaderAnimation />
  ...
  const stats = [
    ...
    { title: 'Intitial Market Cap', value: `${cryptoDetails.listedAt && millify(cryptoDetails?.listedAt)}`, icon: <ThunderboltOutlined /> },
    { title: 'Current Market Cap', value: `$ ${cryptoDetails?.marketCap && millify(cryptoDetails?.marketCap)}`, icon: <DollarCircleOutlined /> },
